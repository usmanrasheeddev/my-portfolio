  ...
  return (
    <div id="projects" className="py-10">
      ...
      <div className="w-full grid-cols-1 sm:grid-cols-2 py-5 grid gap-5">
        ...
        />
        <ProjectCard
          name={"A Step Toward Haq"}
          img={"/assets/projects/a step toward haq/sth1.png"}
          description={
            "A full-stack Islamic education platform built for an online Quran and Arabic learning institute. Features structured courses with progress tracking, automated certificate generation, a visual referral tree system, a dedicated admin panel, and real-time notifications — designed to serve a growing global student community."
          }
          tech={[
            "HTML",
            "CSS",
          ...
          link={"https://asteptowardhaq.netlify.app/"}
          casestudy={"/project/a-step-toward-haq"}
        />
        <ProjectCard
          name={"Movers Packers Dubai"}
          img={"/assets/projects/movers&packers/N.png"}
          description={
            "A production-ready movers and packers platform for Dubai with service discovery, multi-step bookings, photo uploads, order tracking, customer authentication, transactional emails, and a protected admin dashboard for managing the full booking workflow."
          }
          tech={[
            "React 19",
            "TypeScript",
          ...
          link={"https://movers-packers-dubai.vercel.app/"}
          casestudy={"/project/movers-packers"}
        />
        <ProjectCard
          name={"Blogify"}
          img={"/assets/projects/Blogify/blog_project1.png"}
          description={
            "A full-featured personal blogging platform built with PHP and MySQL/SQLite. Blogify includes role-based access control, article publishing, media uploads, category search, pagination, comments, user dashboards, admin moderation, and serverless Vercel deployment support."
          }
          tech={[
            "PHP",
            "MySQL",
        ...
        <ProjectCard
          ...
          link={"https://github.com/usmanrasheeddev/HinglishMagic"}
        ...
        <ProjectCard
          ...
          link={"https://github.com/usmanrasheeddev/Snappet-CLI"}
        />
      </div>
    </div>
  );
