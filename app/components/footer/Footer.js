                            ...
                            {open && (
                                ...
                                >
                                    <div className="text-white flex flex-wrap flex-col">
                                        <span className="text-sm font-medium">Usman Rasheed</span>
                        ...
                        <AnimatePresence mode="popLayout">
                            {open && (
                                ...
                                >
                                    ...
                                    <a
                                        href="https://www.instagram.com/usmangujjar_dev/"
                                        target="_blank"
                                        className=" hover:text-white transition-all duration: 0.5 flex flex-row gap-1 items-center"
                                    >
                                    ...
                                    <a
                                        href="https://api.whatsapp.com/send?phone=923044993095&text=Hi%20Usman%2C%20I%27m%20amazed%20by%20your%20work!%20%F0%9F%98%8A"
                                        target="_blank"
                                        className=" hover:text-white transition-all duration: 0.5 flex flex-row gap-1 items-center"
                                    >
                                    ...
                                    <a
                                        href="https://www.linkedin.com/in/usmanrasheedcontact/"
                                        target="_blank"
                                        className=" hover:text-white transition-all duration: 0.5 flex flex-row gap-1 items-center"
                                    >
                                    ...
                                    <a
                                        href="https://github.com/usmanrasheeddev"
                                        target="_blank"
                                        className=" hover:text-white transition-all duration: 0.5 flex flex-row gap-1 items-center"
                                    >
